...
gulp.task('server', shell.task([
  'go build -o bin/example-server github.com/pfilippi24/grpc-gateway/examples/internal/cmd/example-grpc-server',
]));

gulp.task('gateway', shell.task([
  'go build -o bin/example-gw github.com/pfilippi24/grpc-gateway/examples/internal/cmd/example-gateway-server',
]));
