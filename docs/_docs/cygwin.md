...
Then `go get -u -v` the following packages:
    ...
    go get -u -v github.com/pfilippi24/grpc-gateway/protoc-gen-grpc-gateway
    go get -u -v github.com/pfilippi24/grpc-gateway/protoc-gen-swagger
    go get -u -v github.com/golang/protobuf/protoc-gen-go

This will probably fail with similar output.

    github.com/pfilippi24/grpc-gateway (download)
    # cd .; git clone https://github.com/pfilippi24/grpc-gateway C:\path\to\your\cygwin\home\user\go\src\github.com\grpc-ecosystem\grpc-gateway
    ...
    package github.com/pfilippi24/grpc-gateway/protoc-gen-grpc-gateway: exit status 128
...
Copy and paste these lines into your shell and change the clone destination directories.
    ...
    git clone https://github.com/pfilippi24/grpc-gateway $(cygpath -u $GOPATH)/src/github.com/pfilippi24/grpc-gateway
...
## Usage
Follow the [instuctions](https://github.com/pfilippi24/grpc-gateway#usage) in the [README](https://github.com/pfilippi24/grpc-gateway).

Adjust steps 3, 5 and 7 like this. protoc expects native windows paths.

    protoc -I. -I$(cygpath -w /usr/local/include) -I${GOPATH}/src -I${GOPATH}/src/github.com/pfilippi24/grpc-gateway/third_party/googleapis --go_out=plugins=grpc:. ./path/to/your_service.proto
    protoc -I. -I$(cygpath -w /usr/local/include) -I${GOPATH}/src -I${GOPATH}/src/github.com/pfilippi24/grpc-gateway/third_party/googleapis --grpc-gateway_out=logtostderr=true:. ./path/to/your_service.proto
    protoc -I. -I$(cygpath -w /usr/local/include) -I${GOPATH}/src -I${GOPATH}/src/github.com/pfilippi24/grpc-gateway/third_party/googleapis --swagger_out=logtostderr=true:. ./path/to/your_service.proto
